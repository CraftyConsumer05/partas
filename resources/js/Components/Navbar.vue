  ...
  <nav class="fixed top-0 z-50 w-full bg-gradient-to-b from-green-400 to-blue-400">
    ...
    <div class="flex items-center">
      <div class="flex items-center ml-3 relative">
        <!-- Profile button -->
        <a href="#" class="flex text-white px-2 bg-blue-400 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600 dropdown-button" aria-expanded="false" @click.prevent="toggleDropdown">
